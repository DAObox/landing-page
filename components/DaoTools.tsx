			...
			<div className="pt-20 sm:pt-0 space-y-14">
				<div className="space-y-2">
					<div className={Panchang.className}>
						<h1 className="text-4xl md:text-6xl font-medium text-center text-transparent bg-clip-text bg-gradient-to-br from-trans-gray via-white to-trans-gray">
							DAO Tools
						</h1>
					</div>
					<div className="lg:text-2xl">
						<p className="text-center bg-clip-text bg-gradient-to-br from-trans-gray text-white">
							Custom architecture, U.I and plugins for
						</p>
						<p className="text-center text-transparent bg-clip-text bg-gradient-to-br from-trans-gray text-white">
							Aragon OSx protocol.
						</p>
					</div>
				</div>
