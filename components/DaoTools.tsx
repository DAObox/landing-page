		...
		<div className="pt-20 sm:pt-0 space-y-14">
			<div className="space-y-2">
				...
				<div className="lg:text-2xl">
					<p className="text-center text-white bg-clip-text bg-gradient-to-br from-trans-gray">
						Custom architecture, U.I and plugins for
					</p>
					<p className="text-center text-transparent text-white bg-clip-text bg-gradient-to-br from-trans-gray">
						Aragon OSx protocol.
					</p>
				</div>
			</div>
