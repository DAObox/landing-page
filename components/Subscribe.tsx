		...
		<div className="flex flex-col items-center justify-center w-full h-full max-w-lg px-5 lg:max-w-4xl">
			...
			<div className="flex flex-col items-center w-full -mt-32 space-y-4 text-center lg:max-w-3xl">
				<div className={Panchang.className}>
					<h1 className="text-3xl font-medium text-center text-white sm:text-5xl md:hidden">
						Access DAOs through innovative tools
					</h1>
					<h1 className="hidden text-3xl font-medium text-center text-white sm:text-5xl 
						md:flex md:flex-col md:space-y-2.5">
						<span className="flex justify-center space-x-3">
							<span>Access DAOs</span><span className="hidden lg:block">through</span>
						</span>
						<div className="flex flex-col space-y-2.5 justify-center lg:flex-row lg:space-x-2.5 lg:items-center lg:space-y-0">
							<span className="flex space-x-2.5 justify-center items-center">
